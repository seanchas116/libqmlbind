...
qmlbind_value *qmlbind_value_clone(qmlbind_value *other)
{
...
int qmlbind_value_has_property(qmlbind_value *self, const char *key)
{
    return self->hasProperty(key);
}

int qmlbind_value_has_index(qmlbind_value *self, int index)
{
    return self->hasProperty(QString::number(index));
}

int qmlbind_value_has_own_property(qmlbind_value *self, const char *key)
{
    return self->hasOwnProperty(key);
}

qmlbind_value *qmlbind_value_get_prototype(qmlbind_value *self)
{
...
qmlbind_value *qmlbind_value_get_array_item(qmlbind_value *self, int index)
{
