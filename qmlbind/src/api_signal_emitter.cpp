...
void qmlbind_signal_emitter_emit(qmlbind_signal_emitter *self, const char *signal_name, int argc, qmlbind_value **argv)
{
    self->emitSignal(signal_name, argc, argv);
}

qmlbind_engine *qmlbind_signal_emitter_get_engine(qmlbind_signal_emitter *self)
{
